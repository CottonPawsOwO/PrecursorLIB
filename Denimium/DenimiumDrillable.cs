    ...
    internal class DenimiumDrillable : BindablePrefab
    {
        ...
        private void ApplyChangesToPrefab(GameObject prefab)
        {
            ...
            if (component != null)
            {
                ...
                component.maxResourcesToSpawn = 4;
                component.health = new float[] { 40f };
            ...
            foreach (Renderer renderer in componentsInChildren)
            {
                ...
                renderer.material.SetColor("_Color", new Color(0.25f, 0.15f, 0.35f, 0.9f));
                renderer.material.SetColor("_SpecColor", new Color(0.8f, 0.6f, 0.9f));
                renderer.material.SetColor("_GlowColor", new Color(0.4f, 0.2f, 0.6f, 1f));
